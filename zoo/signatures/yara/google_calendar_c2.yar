...
rule GlassWorm_Google_Calendar_C2 {
    meta:
        description = "Detects Google Calendar C2 fallback patterns"
        severity = "high"
        score = "80"
...
rule GlassWorm_Calendar_Event_Commands {
    meta:
        description = "Detects calendar event parsing for C2 commands"
        severity = "high"
        score = "85"
        author = "Kirin Scanner - GlassWorm Detection Suite"
        date = "2025-10-18"
...
rule GlassWorm_Calendar_Backup_C2 {
    meta:
        description = "Detects calendar-based backup C2 mechanisms"
        severity = "medium"
        score = "70"
        author = "Kirin Scanner - GlassWorm Detection Suite"
        date = "2025-10-18"
...
rule GlassWorm_Calendar_Event_Exfiltration {
    meta:
        description = "Detects calendar event-based data exfiltration"
        severity = "medium"
        score = "75"
        author = "Kirin Scanner - GlassWorm Detection Suite"
        date = "2025-10-18"
